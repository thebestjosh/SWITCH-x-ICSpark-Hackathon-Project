            ...
            <div>
              <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-medium text-gray-800">Emails</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-gray-900">Email</p>
                      <a href="mailto:jzhang27@punahou.edu" className="text-sm text-primary hover:underline">
                        jzhang27@punahou.edu
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-gray-900">Email</p>
                      <a href="mailto:jwilliams27@punahou.edu" className="text-sm text-primary hover:underline">
                        jwilliams27@punahou.edu
                      </a>
                    </div>
                  </div>
                  
                  <h4 className="text-lg font-medium text-gray-800">Phone Numbers</h4>
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <svg className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-gray-900">Phone</p>
                      <a href="tel:+18082348547" className="text-sm text-primary hover:underline">
                        (808) 234-8547
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-gray-900">Phone</p>
                      <a href="tel:+18084937250" className="text-sm text-primary hover:underline">
                        (808) 493-7250
                      </a>
                    </div>
                  </div>
